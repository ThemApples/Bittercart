...
public class ExampleAdapter extends RecyclerView.Adapter<ExampleAdapter.ExampleViewHolder> {
    private ArrayList<ShoppingList> mExampleList;
        ...
        public ExampleViewHolder(View itemView) {
            ...
            linear.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ShoppingList items = mExampleList.get(getAdapterPosition());
    ...
    public ExampleAdapter(ArrayList<ShoppingList> exampleList) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ShoppingList currentItem = mExampleList.get(position);
